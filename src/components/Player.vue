<template>
  <div class="fixed bottom-0 left-0 bg-white px-4 py-2 w-full">
    ...
    <div class="text-center">
      <span class="song-title font-bold" v-if="current_song.modified_name">{{ current_song.modified_name }} by </span> 
      <span class="song-artist">{{ current_song.display_name }}</span>
    </div>
    <div class="flex flex-nowrap gap-4 items-center">
      <!-- Play/Pause Button -->
      <button type="button" @click.prevent="toggleAudio" id="playerPlayBtn">
        <i
