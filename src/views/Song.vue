    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        <div class="z-50 text-left ml-8">
          ...
          <div>{{ song.genre }}</div>
          <div class="song-price">{{ $n(1, "currency", "tw") }}</div>
        </div>
      </div>
    </section>
    <!-- Form -->
...
export default {
  ...
  computed: {
    ...
    sortedComments() {
      // 不加上slice()產出新的array會報錯：side effect
  ...
  methods: {
    ...
    async addComment(val, context) {
      ...
      // console.log('context', context) from vee validate
      context.resetForm();
    },
    async getComments() {
